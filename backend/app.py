...
PRIVATE_KEY = "d1e6f833fcb720bc7428d8cf1d479641bfedbb75b08efbddd7c70f43cf3bad30"
ACCOUNT_ADDRESS = "0x578EBf0501c9c108AD61B1dEcc90242907c5BD70"
...
CONTRACT_ABI = [
    ...
    { "inputs": [], "name": "loanCount", "outputs": [
        { "internalType": "uint256", "name": "", "type": "uint256" }
    ], "stateMutability": "view", "type": "function" },
    { "inputs": [ { "internalType": "uint256", "name": "_amount", "type": "uint256" },
                  { "internalType": "uint256", "name": "_duration", "type": "uint256" },
                  { "internalType": "string", "name": "_decision", "type": "string" } ],
      "name": "storeLoan", "outputs": [], "stateMutability": "nonpayable", "type": "function" }
]
...
def predict():
    try:
        ...
        # Default duration (for blockchain)
        ...
        emp_encoded = emp_map.get(employment_status, 0)
        home_encoded = home_map.get(home_ownership, 0)
        ...
        try:
            if web3.is_connected():
                ...
                print(f"✅ Blockchain Txn Sent: {tx_hash_hex}")
        except Exception as bc_error:
            print("⚠️ Blockchain Error:", bc_error)
